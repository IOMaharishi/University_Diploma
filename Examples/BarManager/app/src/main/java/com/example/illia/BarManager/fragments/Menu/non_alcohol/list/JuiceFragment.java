 ...
 */
 public class JuiceFragment extends Fragment {
    ...
    static CoreMenuData itemsData[] = { new CoreMenuData("Морс брусничный", R.drawable.help, "Some Price"),
            new CoreMenuData("Морс клюквенный",R.drawable.content_discard,"Some price"),
            new CoreMenuData("Валио персиковый",R.drawable.content_discard,"Some price"),
            new CoreMenuData("Нико томатный",R.drawable.content_discard,"Some price"),
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.juice_activity, container, false);
